...
<body>
  ...
  <div class="ui main container">
    <div class="ui secondary  menu">
      ...
      <a href="ten.php" class="item active" id="priceLastmenuten">TEN</a>
...
$(document).ready(function () {
  ...
  function depth(){
    ...
    $.getJSON('https://vip.bitcoin.co.id/api/ten_idr/trades', function(data){
    ...
    $.getJSON('https://vip.bitcoin.co.id/api/ten_idr/depth', function(data){  
